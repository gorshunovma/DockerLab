...
df -h
sudo chown -R astra:astra ./postgresql/
rm -Rfv ./postgresql/data/* ./postgresql/log/*  ./postgresql/etc/*

docker build --no-cache --platform linux/amd64 -t ubuntu24.04-postgres16:1.0 .
